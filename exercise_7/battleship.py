...
class HumanPlayer:
    ...
    def take_turn(self):
        ...
        print('You have attacked', self.board.attack_count, 'times, with'\
                      ,self.board.attack_count - self.board.miss_count, 'hits and', self.board.miss_count, 'misses.')
        ...
        self.board.attack_count += 1
        if hit_flag:
            print("You hit a boat!")
        else:
            self.board.miss_count += 1
            print("You missed.")
...
# The ComputerPlayer class represents a player without user input .
class ComputerPlayer:
    ...
    # link the computer to the player
    def set_opponent(self, opponent):
        self.opponent = opponent
    ...
    def take_turn(self):
        ...
        hit_flag = self.opponent.board.attack(x, y)
        if hit_flag:
            print("The computer attacked", position, " and hit.")
        else:
            print("The computer attacked", position, "and missed.")
        # Return true if the opponent has been defeated.  Otherwise, false.
        if self.opponent.board.is_defeated():
            return True
        else:
